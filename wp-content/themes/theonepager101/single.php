...
?>
    	...
    	<div class="col-full">
        	...
        	?>
				<article <?php post_class(); ?>>
					...
					<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=treebox3"></script>
  ...
  <style type="text/css">
	#call-to-action, #header p, .post-category, .post .post-date-author{
		display: none;
	}
