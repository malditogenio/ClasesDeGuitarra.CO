    	...
    	<div class="col-full">
			...
			?>		
				<article <?php post_class(); ?>>
					...
					?>
						<li>
							<span class="date"><?php the_time( 'F j' ); ?><sup><?php the_time( 'S' ); ?></sup></span> <span class="linked"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></span> <span class="comments"><?php comments_popup_link( __( '0', 'woothemes' ), __( '1', 'woothemes' ), __( '%', 'woothemes' ), __( '', 'woothemes' ), __( '', 'woothemes' ) ); ?></span>
						</li>
					<?php
